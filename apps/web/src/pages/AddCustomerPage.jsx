    ...
    <div className="max-w-4xl mx-auto space-y-4 sm:space-y-5 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-4">
        ...
        <div className="text-left sm:text-right">
          <h2 className="text-sm sm:text-base font-bold" style={{ color: 'var(--gray-900)', fontFamily: 'var(--font-heading)' }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
        ...
        <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5 sm:gap-3 py-1">
          <button type="button" onClick={() => onNavigate('DASHBOARD')} className="btn-secondary w-full sm:w-auto">
            Cancel
          </button>
          <button id="save-customer-btn" type="submit" disabled={loading} className="btn-primary w-full sm:w-auto">
